...
1. PARTIES: The parties to this lease are:
       the owner of the Property, Landlord,:         His Kingdom Properties, LLC
                                                                                                                     ; and
       Tenant(s):                     Jenny and Paul Christensen
                                                                                                                          .

2. PROPERTY: Landlord leases to Tenant the following real property:
                                            24015 Tayloe House Ln Dr, Katy, TX, 77493
       Address:
       legally described as:        Lot 15, Blok 8, Section 1 of Williamsburg Hamlet

       in             Harris                          County, Texas, together with the following non-real-property
       items:
                                                                                                                          .
...
3. TERM:
   ...
   A. Primary Term: The primary term of this lease begins and ends as follows:
       ...
       Commencement Date:               April 1, 2020                 Expiration Date:        June 30, 2021

   B. Delay of Occupancy: Tenant must occupy the Property within 5 days after the Commencement Date.
      If Tenant is unable to occupy the Property by the 5th day after the Commencement Date because of
   ...
   B. If this lease automatically renews on a month-to month basis, it will continue to renew on a month-to-
      ...
      (2) on the date designated in the notice but not sooner than 30 days after the notice is given and, if
           necessary, rent will be prorated on a daily basis.
                                                                                                 ...
                                                                                                 DB
                     Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 1 of 14


Residential Lease concerning:                24015 Tayloe House Ln, Katy, TX, 77493
...
5. RENT:
    ...
    A. Monthly Rent: Tenant will pay Landlord monthly rent in the amount of $ 700.00         for each full month
       during this lease. The first full month's rent is due and payable not later than April 1, 2021          .
       Thereafter, Tenant will pay the monthly rent so that Landlord receives the monthly rent on or before the
    ...
    B. Prorated Rent: On or before                        Tenant will pay Landlord $ 50.00      as prorated
    ...
    C. Place of Payment: Unless this lease provides otherwise, Tenant will remit all amounts due to Landlord
       ...
       Tenant must remit amounts due under this lease.
             ...
             Name:                HIs Kingdom Properties LLC
             Address:             c/o Prosperity Bank, acct # 16050592
                                 1515 W Grand Parkway South, KATY, TX 77494
    ...
    D. Method of Payment:
       ...
       (4) Landlord        requires does not require Tenant(s) to pay monthly rents by one check or draft.
...
6. LATE CHARGES:
    ...
    A. If Landlord does not actually receive a rent payment in the full amount at the designated place of
       payment by 11:59pm p.m. on the 1st      day of the month in which it is due, Tenant will pay Landlord
       for each late payment:

        (1) an initial late charge equal to (check one box only):    (a) $ 50.00      ; or   (b)        % of one
            month's rent; and
        (2) additional late charges of $ 25.00     per day thereafter until rent and late charges are paid in full.
            Additional late charges may not exceed more than 30 days in any one month.
                                                                                           DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 2 of 14


Residential Lease concerning:
                                            24015 Tayloe House Ln, Katy, TX, 77493
    ...
    B. For the purposes of paying rent and any late charges, the mailbox is not the agent for receipt for
       ...
       Landlord's right to exercise remedies under Paragraph 27.

7. RETURNED CHECKS: Tenant will pay Landlord $ 25.00            (not to exceed $25.00) for each check
   Tenant tenders to Landlord which is returned or not honored by the institution on which it is drawn for any
   reason, plus any late charges until Landlord receives payment. Tenant must make any returned check
...
9. PETS:
    ...
    B. If Tenant violates this Paragraph 9 or any agreement to keep a pet on the Property, Landlord may take
       ...
       (2) charge Tenant, as additional rent, an initial amount of $250.00and $      per day thereafter per pet
...
10. SECURITY DEPOSIT:
    ...
    A. Security Deposit: On or before execution of this lease, Tenant will pay a security deposit to Landlord in
       the amount of $     $0.00       . "Security deposit" has the meaning assigned to that term in Section 92.102,
       Property Code.
    ...
    (1) Section 92.108, Property Code provides that a tenant may not withhold payment of any portion of the
        last month's rent on grounds that the security deposit is security for unpaid rent.
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 3 of 14
...
Residential Lease concerning:
    ...
    (2) Bad faith violations of Section 92.108 may subject a tenant to liability up to 3 times the rent wrongfully
    ...
    (5) One may view the Texas Property Code at the Texas Legislature's website which, as of the date
        shown in the lower left-hand corner of this form, is www.capitol.state.tx.us/statutes/pr.toc.htm.
    ...
    B. Unless provided by Landlord, Tenant must, at a minimum, keep the following utilities on, if available, at
       all times this lease is in effect: gas; electricity; water; wastewater; and garbage services.
        ...
        to the Property and are adequate for Tenant's use.
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 4 of 14
...
12. USE AND OCCUPANCY:
    ...
    A. Occupants: Tenant may use the Property as a private residence only. The only persons Tenant may
       ...
       occupants):            Jeffery, Kelvis, and Bella
    ...
    E. Guests: Tenant may not permit any guest to stay on the Property longer the amount of time permitted
       by any owners' association rule or restrictive covenant or 14        days without Landlord's written
...
13. PARKING RULES: Tenant may not permit more than               4   vehicles, including but not limited to
...
14. ACCESS BY LANDLORD:
    ...
    B. Access: Before accessing the Property, Landlord or anyone authorized by Landlord will attempt to first
       ...
       lien; (4) leave written notices; or (5) seize nonexempt property if Tenant is in default.
                                                                                                     DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 5 of 14
...
Residential Lease concerning:
    ...
    C. Trip Charges: If Landlord or Landlord's agents have made prior arrangements with Tenant to access
       ...
       make the Property accessible, Landlord may charge Tenant a trip charge of $ 50.00      .
    ...
    D. Keybox: A keybox is a locked container placed on the Property holding a key to the Property.
       ...
       personal injury). Neither the Association of REALTORS(R) nor MLS requires the use of a keybox.
        ...
        (2) Tenant may withdraw Tenant's authorization to place a keybox on the Property by providing written
            notice to Landlord and paying Landlord a fee of $ 200.00     as consideration for the withdrawal.
        ...
        (3) If Landlord or Landlord's agents have made prior arrangements with Tenant to access the Property
            and are later denied or are not able to access the Property because of Tenant's failure to make the
    ...
    B. Definitions:
        ...
        (2) "Surrender" occurs when all occupants have vacated the Property, in Landlord's reasonable
            judgment, and one of the following events occurs:
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 6 of 14
...
Residential Lease concerning:                    24015 Tayloe House Ln, Katy, TX, 77493
    ...
    C. Personal Property Left After Move-Out:
       (1) If Tenant leaves any personal property in the Property after surrendering or abandoning the
           ...
           (c) store and sell such personal property by following procedures in Section 54.045(b)-(e), Property Code.
    ...
    B. Yard Maintenance:
        ...
        (2) "Maintain the yard" means to perform activities such as, but not limited to: (a) mowing, fertilizing,
            and trimming the yard; (b) controlling pests in the yard; and (c) removing debris from the yard.
                                                                                                   ...
                                                                                                   DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 7 of 14
...
Residential Lease concerning:
        ...
        (3) Tenant will water the yard at reasonable and appropriate times including but not limited to the
            following times:    Twice a week after 6pm or before 10am
    ...
    B. Completion of Repairs:
        ...
        (1) Tenant may not repair or cause to be repaired any condition, regardless of the cause,
            ...
            Landlord's sole discretion.
                                                                                                    ...
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 8 of 14
...
Residential Lease concerning:
    ...
    C. Payment of Repair Costs: Tenant will pay Landlord or any contractor Landlord directs Tenant to
       pay, the first $             of the cost to repair each condition in need of repair, and Landlord
...
19. SECURITY DEVICES AND EXTERIOR DOOR LOCKS:
    ...
    A. Subchapter D, Chapter 92, Property Code requires the Property to be equipped with certain types of
       ...
       has the meaning assigned to that term in Section 92.151, Property Code.
    ...
    B. All notices or requests by Tenant for rekeying, changing, installing, repairing, or replacing security
       ...
       installed only by contractors authorized by Landlord.
                                                                                                    ...
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 9 of 14
...
20. SMOKE DETECTORS: Subchapter F, Chapter 92, Property Code requires the Property to be equipped
    ...
    liability for damages and attorney fees under Section 92.2611, Property Code.
...
23. RESIDENTIAL LANDLORD'S LIEN: Landlord will have a lien for unpaid rent against all of Tenant's
    ...
    property in accordance with the provisions of Section 54.045, Property Code.
...
26. SPECIAL PROVISIONS: (Do not insert a lease-option or lease-purchase clause without the assistance of
    ...
    Landlord will have access to the properties once a month on Saturday 11am to inspect for water leaks, A/C filters, and
                                             the general condition of the property.




                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative:DB
                                                                                                    ____, _____   Page 10 of 14
...
27. DEFAULT:
    ...
    C. Notice to vacate under Paragraph 27B(1) may be by any means permitted by Section 24.005, Property Code.
...
28. EARLY TERMINATION: This lease begins on the Commencement Date and ends on the Expiration date
    ...
    A. Military and Family Violence: Tenants may have special statutory rights to terminate the lease early in
       certain situations involving family violence or a military deployment or transfer.
        ...
        (2) Family Violence: Tenant may terminate this lease if Tenant obtains and provides Landlord with a
            copy of a court order described under Section 92.016, Property Code protecting Tenant or an occupant
            from family violence committed by a cotenant or occupant of the Property. Section 92.016,
    ...
    B. Assignment and Subletting:
        ...
        (1) Tenant may not assign this lease or sublet the Property without Landlord's written consent.
                                                                                                    ...
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 11 of 14
...
31. ADDENDA:       Incorporated into this lease are the following addenda, exhibits and other information. If
    ...
    Regulations as Landlord may, at Landlord's discretion, amend from time to time.
     ...
     X   Pet Agreement                                                Pool/Spa Maintenance Addendum
...
32. NOTICES: All notices under this lease must be in writing and are effective when hand-delivered, sent by
    ...
    Tenant at the Property and a copy to:                           Landlord c/o:
                                                                     Dag Blokkum
                                                                   55 Wyndehaven Lakes Dr
                                                                   Katy, TX, 77494
    E-mail:                                                        E-mail:dblokkum@gmail.com
    Fax:                                                           Fax:

                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 12 of 14
...
33. AGREEMENT OF PARTIES:
    ...
    G. Copyright: If an active REALTOR(R) member of the Texas Association of REALTORS(R) or an active
...
34. INFORMATION:
    ...
    F. The Texas Department of Public Safety maintains a database that the public may search, at no cost, to
       ...
       department.
                                                                                                    DB
                        Tenants: _____, _____, _____, _____ & Landlord or Landlord's Representative: ____, _____   Page 13 of 14


Residential Lease concerning:
                                                  24015 Tayloe House Ln, Katy, TX, 77493

      G. Landlord's insurance does not cover Tenant from loss of personal property. Landlord recommends that
         Tenant obtain insurance for casualties such as fire, flood, water damage, and theft. Tenant represents
         that Tenant     intends     does not intend to purchase such insurance.

      H. Landlord's broker,                                                                                                           ,
           will will not act as the property manager for landlord.

      I.   This lease is negotiable between the parties. This lease is binding upon final acceptance. READ IT
           CAREFULLY. If you do not understand the effect of this lease, consult your attorney BEFORE signing.




Landlord      His Kingdom Properties LLC               Date                Tenant   Paul Christensen                             Date




Landlord                                               Date                Tenant   Jenny Christensen                            Date


Or signed for Landlord under written property management
agreement or power of attorney:                                            Tenant              Text                              Date
By:
                                                       Date                Tenant                                                 Date
Printed Name:
Firm Name:
...
Paragraph                   Pg.   Paragraph                   Pg.     Paragraph                 Pg.    Paragraph                   Pg.

1. Parties                   1    10. Security Deposit         3      15. Move-In Condition        6   20. Smoke Detectors            10
2. Property                  1        A. Security Deposit             16. Move-Out                 6   21. Liability                  10
3. Term                      1        B. Interest                         A. Move-Out Condition        22. Holdover                   10
    A. Primary Term                   C. Refund                           B. Definitions               23. Landlord's Lien            10
    B. Delay of Occupancy             D. Deductions                       C. Personal Prop. Left       24. Subordination              10
4. Renewal & Termination     1    11. Utilities                4      17. Property Maintenance 7       25. Casualty & Condemn. 10
5. Rent                      2    12. Use & Occupancy          5          A. Tenant's General          26. Special Provisions         10
   A. Monthly Rent                    A. Occupants                        B. Yard Maintenance          27. Default                    11
   B. Prorated Rent                   B. Phone Numbers                    C. Pool/Spa                  28. Early Termination          11
   C. Place of Payment                C. HOA Rules                        D. Prohibitions                  A. Military & Family Viol.
   D. Method of Payment               D. Prohibitions                     E. Failure to Maintain           B. Assignment & Sublet
   E. Rent Increases                  E. Guests                       18. Repairs                  8   29. Attorney's Fees            12
6. Late Charges              2        F. Common Areas                     A. Repair Requests           30. Representations            12
7. Returned Checks           3    13. Parking Rules            5          B. Completion of Repairs     31. Addenda                    12
8. Application of Funds      3    14. Access by Landlord       5          C. Payment of Repairs        32. Notices                    12
9. Pets                      3        A. Signs                            D. Trip Charges              33. Agreement of Parties       13
                                      B. Access                           E. Advance Payments          34. Information                13
                                      C. Trip Charges                 19. Security Devices         9
                                      D. Keybox
